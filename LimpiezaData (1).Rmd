...
#Variable: INDICE DE PAZ MUNDIAL (va del 1 al 5)
...
```{r}
dataFINAL = select(dataFINAL, ISO, pais, Migracion_2022, Criminalidad, PCorrupcion_2021, Desempleo_2021, PBI_2020, 'E2: Economic Inequality', EmisionesCO2, LegitimidadEstatal, Paz, Catastrofe)
```
